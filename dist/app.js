...
(function(exports) {
  ...
  var IncAngSpeed = (function () {
      function IncAngSpeed(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      IncAngSpeed.create = function (value0) {
          return function (value1) {
              return new IncAngSpeed(value0, value1);
          };
      };
      return IncAngSpeed;
  })();
  var IncreaseSpeed = (function () {
      function IncreaseSpeed(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      IncreaseSpeed.create = function (value0) {
          return function (value1) {
              return new IncreaseSpeed(value0, value1);
          };
      };
      return IncreaseSpeed;
  })();
  var DecreaseSpeed = (function () {
      function DecreaseSpeed(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DecreaseSpeed.create = function (value0) {
          return function (value1) {
              return new DecreaseSpeed(value0, value1);
          };
      };
  ...
  var ReverseDir = (function () {
      function ReverseDir(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ReverseDir.create = function (value0) {
          return function (value1) {
              return new ReverseDir(value0, value1);
          };
      };
      return ReverseDir;
  })();
  var AdjustSize = (function () {
      function AdjustSize(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      AdjustSize.create = function (value0) {
          return function (value1) {
              return new AdjustSize(value0, value1);
          };
      };
      return AdjustSize;
  })();
  ...
  var rotate = function (v) {
      ...
      return function ($174) {
          return rotateZ(v.za)(rotateY(v.ya)(rotateX(v.xa)($174)));
      };
  };
  ...
  var renderCube = function (idx) {
      return function (cube) {
          ...
          var getInt = function (mi) {
              return Data_Maybe.fromMaybe(0)(mi);
          };
          var getColor = function (mc) {
              var $$default = new Svg_Attributes.RGB(0, 0, 0);
              return Data_Maybe.fromMaybe($$default)(mc);
          };
          var drawVertex = function (idx1) {
              return function (v) {
                  return Svg_Elements.g([  ])([ Svg_Elements.text([ Svg_Attributes.x(v.x + 5.0), Svg_Attributes.y(v.y - 5.0), Svg_Attributes.fill(new Data_Maybe.Just(new Svg_Attributes.RGB(0, 0, 0))) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(idx1)) ]), Svg_Elements.circle([ Svg_Attributes.r(3.0), Svg_Attributes.cx(v.x), Svg_Attributes.cy(v.y), Svg_Attributes.fill(new Data_Maybe.Just(new Svg_Attributes.RGB(0, 0, 0))) ]) ]);
              };
          };
          var drawVertices = function (vert2Ds) {
              return Data_Array.mapWithIndex(drawVertex)(vert2Ds);
          };
          var drawRect = function (a) {
              return function (b) {
                  return function (c) {
                      return function (d) {
                          return function (color) {
                              return Svg_Elements.path([ Svg_Attributes.d([ new Svg_Attributes.Abs(new Svg_Attributes.M(a.x, a.y)), new Svg_Attributes.Abs(new Svg_Attributes.L(b.x, b.y)), new Svg_Attributes.Abs(new Svg_Attributes.L(c.x, c.y)), new Svg_Attributes.Abs(new Svg_Attributes.L(d.x, d.y)) ]), Svg_Attributes.stroke(new Data_Maybe.Just(new Svg_Attributes.RGB(150, 0, 0))), Svg_Attributes.fill(new Data_Maybe.Just(color)) ]);
                          };
                      };
                  };
              };
          ...
          var drawSurfaces = function (surfaces) {
              return function (verts) {
                  return function (colors) {
                      return Data_Array.mapWithIndex(function (idx1) {
                          return function (surface) {
                              return drawRect(getPoint(Data_Array.index(verts)(getInt(Data_Array.index(surface)(0)))))(getPoint(Data_Array.index(verts)(getInt(Data_Array.index(surface)(1)))))(getPoint(Data_Array.index(verts)(getInt(Data_Array.index(surface)(2)))))(getPoint(Data_Array.index(verts)(getInt(Data_Array.index(surface)(3)))))(getColor(Data_Array.index(colors)(idx1)));
                          };
                      })(surfaces);
                  };
              };
          };
          var drawCube = function (surfaces) {
              return function (vert2Ds) {
                  return function (colors) {
                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(drawSurfaces(surfaces)(vert2Ds)(colors))(drawVertices(vert2Ds));
                  };
              };
          };
          var vert2Ds = Data_Functor.map(Data_Functor.functorArray)(project(cube.size))(cube.shape.vertices);
          var normals$prime = Data_Array.filter(function (normal) {
              return normal.z > 0.0;
          })(cube.shape.normals);
          var surfaces$prime = Data_Functor.map(Data_Functor.functorArray)(function (normal) {
              return Data_Maybe.fromMaybe([  ])(Data_Array.index(cube.shape.surfaces)(normal.i));
          })(normals$prime);
          var colors$prime = Data_Functor.map(Data_Functor.functorArray)(function (normal) {
              return getColor(Data_Array.index(cube.shape.colors)(normal.i));
          })(normals$prime);
          return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("Reverse Direction")(ReverseDir.create(idx)), renderButton("Increase Speed")(IncreaseSpeed.create(idx)), renderButton("Decrease Speed")(DecreaseSpeed.create(idx)) ])([ Svg_Elements.svg([ Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Svg_Elements.g([  ])(drawCube(surfaces$prime)(vert2Ds)(colors$prime)) ]) ]));
      };
  };
  var renderView = function (state) {
      var renderSlider = Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.min(5.0), Halogen_HTML_Properties.max(10.0), Halogen_HTML_Properties.required(true), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(AdjustSize.create)) ]);
      var renderGuide = function (label) {
          return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(label) ]);
      };
      var renderButton = function (label) {
          return function (query) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(label), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(query)) ])([ Halogen_HTML_Core.text(label) ]);
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("div1"), Halogen_HTML_Events.onKeyDown(function (e) {
          var v = DOM_Event_KeyboardEvent.code(e);
          if (v === "Numpad1") {
              return new Data_Maybe.Just(Halogen_Query.action(IncAngSpeed.create(X.value)));
          };
          if (v === "Numpad2") {
              return new Data_Maybe.Just(Halogen_Query.action(IncAngSpeed.create(Y.value)));
          };
          if (v === "Numpad3") {
              return new Data_Maybe.Just(Halogen_Query.action(IncAngSpeed.create(Z.value)));
          };
          if (v === "KeyA") {
              return new Data_Maybe.Just(Halogen_Query.action(AddCube.create));
          };
          if (v === "KeyR") {
              return new Data_Maybe.Just(Halogen_Query.action(RemoveCube.create));
          };
          return new Data_Maybe.Just(Halogen_Query.action(NoAction.create));
      }) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([  ])([ renderButton("RotateX")(IncAngSpeed.create(X.value)), renderButton("RotateY")(IncAngSpeed.create(Y.value)), renderButton("RotateZ")(IncAngSpeed.create(Z.value)), renderButton("Add Cube")(AddCube.create), renderButton("Remove Cube")(RemoveCube.create), renderGuide("Adjut Cube Size"), renderSlider ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderGuide("Click RotateX/RotateY/RotateZ buttons or 1/2/3 key to rotate along X-axis/Y-axis/Z-axis"), renderGuide("Click A / R key to add and remove cube") ])(Data_Array.mapWithIndex(renderCube)(state.cubes))));
  };
  ...
  var initCube = {
      cubes: [ {
          shape: {
              ...
              surfaces: [ [ 1, 0, 2, 3 ], [ 0, 2, 6, 4 ], [ 0, 1, 5, 4 ], [ 4, 5, 7, 6 ], [ 1, 3, 7, 5 ], [ 2, 3, 7, 6 ] ],
              colors: [ new Svg_Attributes.RGB(100, 100, 0), new Svg_Attributes.RGB(0, 150, 75), new Svg_Attributes.RGB(255, 0, 150), new Svg_Attributes.RGB(255, 255, 0), new Svg_Attributes.RGB(0, 150, 150), new Svg_Attributes.RGB(255, 0, 0) ],
              normals: [ {
                  x: 0.0,
                  y: 0.0,
                  z: 100.0,
      ...
      var $$eval = function (v) {
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var newCubes = Data_Functor.map(Data_Functor.functorArray)(function (cube) {
                      var $92 = {};
                      for (var $93 in cube) {
                          if ({}.hasOwnProperty.call(cube, $93)) {
                              $92[$93] = cube[$93];
                          };
                      };
                      $92.shape = (function () {
                          var $89 = {};
                          for (var $90 in cube.shape) {
                              if ({}.hasOwnProperty.call(cube.shape, $90)) {
                                  $89[$90] = cube["shape"][$90];
                              };
                          };
                          $89.vertices = rotateShape(cube.shape.vertices)(anglePerFrame(cube.angVel));
                          $89.normals = rotateShape(cube.shape.normals)(anglePerFrame(cube.angVel));
                          return $89;
                      })();
                      $92.angVel = dampenAngSpeed(cube.angVel);
                      $92.angInc = cube.angInc;
                      $92.angDir = cube.angDir;
                      $92.size = cube.size;
                      return $92;
                  })(v1.cubes);
          ...
          if (v instanceof IncAngSpeed) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("rotate")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Functor.map(Data_Functor.functorArray)(function (cube) {
                          if (v.value0 instanceof X) {
                              var $106 = {};
                              for (var $107 in cube) {
                                  if ({}.hasOwnProperty.call(cube, $107)) {
                                      $106[$107] = cube[$107];
                                  };
                              };
                              $106.angVel = (function () {
                                  var $103 = {};
                                  for (var $104 in cube.angVel) {
                                      if ({}.hasOwnProperty.call(cube.angVel, $104)) {
                                          $103[$104] = cube["angVel"][$104];
                                      };
                                  };
                                  $103.xa = cube.angDir * (cube.angVel.xa + cube.angInc);
                                  return $103;
                              })();
                              return $106;
                          };
                          if (v.value0 instanceof Y) {
                              var $112 = {};
                              for (var $113 in cube) {
                                  if ({}.hasOwnProperty.call(cube, $113)) {
                                      $112[$113] = cube[$113];
                                  };
                              };
                              $112.angVel = (function () {
                                  var $109 = {};
                                  for (var $110 in cube.angVel) {
                                      if ({}.hasOwnProperty.call(cube.angVel, $110)) {
                                          $109[$110] = cube["angVel"][$110];
                                      };
                                  };
                                  $109.ya = cube.angDir * (cube.angVel.ya + cube.angInc);
                                  return $109;
                              })();
                              return $112;
                          };
                          if (v.value0 instanceof Z) {
                              ...
                              $118.angVel = (function () {
                                  var $115 = {};
                                  for (var $116 in cube.angVel) {
                                      if ({}.hasOwnProperty.call(cube.angVel, $116)) {
                                          $115[$116] = cube["angVel"][$116];
                                      };
                                  };
                                  $115.za = cube.angDir * (cube.angVel.za + cube.angInc);
                                  return $115;
                              })();
                              return $118;
                          };
                          throw new Error("Failed pattern match at Cube line 364, column 31 - line 367, column 107: " + [ v.value0.constructor.name ]);
                      })(v1.cubes);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $121 = {};
                          for (var $122 in v1) {
          ...
          if (v instanceof AddCube) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("add_cube")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Array.cons({
                          shape: {
                              vertices: [ {
                                  x: 100.0,
                                  y: 100.0,
                              ...
                              surfaces: [ [ 1, 0, 2, 3 ], [ 0, 2, 6, 4 ], [ 0, 1, 5, 4 ], [ 1, 3, 7, 5 ], [ 4, 5, 7, 6 ], [ 2, 3, 7, 6 ] ],
                              colors: [ new Svg_Attributes.RGB(100, 100, 0), new Svg_Attributes.RGB(0, 150, 75), new Svg_Attributes.RGB(255, 0, 150), new Svg_Attributes.RGB(255, 255, 0), new Svg_Attributes.RGB(0, 150, 150), new Svg_Attributes.RGB(255, 0, 0) ],
                              normals: [ {
                                  x: 0.0,
                                  y: 0.0,
          ...
          if (v instanceof RemoveCube) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("remove_cube")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Array.drop(1)(v1.cubes);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $136 = {};
                          for (var $137 in v1) {
          ...
          if (v instanceof ReverseDir) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("reverse_direction")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Array.mapWithIndex(changeDir(v.value0))(v1.cubes);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $143 = {};
                          for (var $144 in v1) {
          ...
          if (v instanceof AdjustSize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("adjust_size")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Functor.map(Data_Functor.functorArray)(function (cube) {
                          return adjustSize(Data_Maybe.fromMaybe(0.0)(Data_Number.fromString(v.value0)))(cube);
                      })(v1.cubes);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $151 = {};
                          for (var $152 in v1) {
          ...
          if (v instanceof NoAction) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("no action")))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof IncreaseSpeed) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("increase_speed")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Array.mapWithIndex(increaseSpeed(v.value0))(v1.cubes);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $160 = {};
                          for (var $161 in v1) {
          ...
          if (v instanceof DecreaseSpeed) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("decrease_speed")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var newCubes = Data_Array.mapWithIndex(decreaseSpeed(v.value0))(v1.cubes);
                      var newCubeState = (function () {
                          var $168 = {};
                          for (var $169 in v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(newCubeState))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Cube line 341, column 12 - line 470, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["Tick"] = Tick;
  exports["IncAngSpeed"] = IncAngSpeed;
  ...
  exports["dampenAngSpeed"] = dampenAngSpeed;
